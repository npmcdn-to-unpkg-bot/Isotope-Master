...
//   // 	jQuery('.grid-item').toggleClass('gigante');
//   // });
//   grid.isotope('layout');
...
jQuery(function() {
 //----- OPEN
    jQuery('[data-popup-open]').on('click', function(e)  {
    	var clicked_button = jQuery(this).parent();
    	jQuery(clicked_button.children('.popup')).fadeIn(50);
        e.preventDefault();
    });
    ...
    jQuery('[data-popup-close]').on('click', function(e)  {
        ...
        jQuery('[data-popup="' + targeted_popup_class + '"]').fadeOut(50);
...
jQuery(function(){
	...
	// jQuery(".submit").click(function(e) {
		 // jQuery(clicked_submit) = jQuery(this).parent();
		if (!this.checkValidity()) {
	      ...
	      jQuery(this).removeClass('invalid');
		    ...
		    var url = "/wp-comments-post.php"; // the script where you handle the form input.
		    
		    jQuery.ajax({
		           type: "POST",
		           url: url,
		           // data: $clicked_submit.serialize(), // serializes the form's elements.
		           data: jQuery(this).serialize(),
		           // data: jQuery(".comment-form").serialize(), // serializes the form's elements.
		    ...
		    (jQuery(this).parent(".comment-respond")).find(".comment-reply-title").text("Thank you for your feedback.");
		    jQuery(this).hide();
